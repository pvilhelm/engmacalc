...
se: e                           {$$ = $1; $$->loc = @$;}
    ...
    | IF e DO se ELSE sl_elseif_list END { $$ = new ast_node_if{$2, $4, $6}; $$->loc = @$;}
        /* The also statement expression is executed if atleast of IF condition was true. */
    | IF e DO se ELSE sl_elseif_list ALSO DO se END { $$ = new ast_node_if{$2, $4, $6, $9}; $$->loc = @$;}
    ...
    | IF e DO exp_list ELSE elseif_list END { $$ = new ast_node_if{$2, $4, $6}; $$->loc = @$;}
    | IF e DO exp_list ELSE elseif_list ALSO DO exp_list END 
                                            { $$ = new ast_node_if{$2, $4, $6, $9}; $$->loc = @$;}
...
/* A list of ifelses */
elseif_list: IF e DO exp_list              { $$ = new ast_node_if{$2, $4, 0}; $$->loc = @$;}
...
sl_elseif_list: IF e DO se                 { $$ = new ast_node_if{$2, $4, 0}; $$->loc = @$;}
